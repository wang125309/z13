<template>
    <div>
        ...
        <div :class="tabBarCls">
            ...
            <TabBarCell :active="getActive(2)" url="/" icon="activity">社区活动</TabBarCell>
            <TabBarCell :active="getActive(3)" url="/" icon="my">我的</TabBarCell>
        </div>
    </div>
</template>
...
<script>
    ...
    export default {
        ...
        computed: {
            tabBarPlaceholderCls() {
                return [
                    `${prefix}-tab-bar-placeholder`
                ]
            },
            tabBarCls() {
                return [
